async function test_items() {
    await commands.add_item([255, [10,11,12], 0.94, 0.92, 0.91, 1.1, 1.2, 1.4, 1000, 990, "ohabcoh", "kekw.com", 499, "type1", "w"]);
    await commands.add_item([256, [10,11,12], 0.94, 0.92, 0.91, 1.1, 1.2, 1.4, 1000, 990, "hoabcho", "kekw.com", 499, "type1", "w"]);
